...
from V_P_N_8 import bot
from V_P_N_8.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from V_P_N_8.sql_helper.botusers_sql import add_me_in_db, his_userid
from V_P_N_8.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @V_P_N_8", alert=True)
