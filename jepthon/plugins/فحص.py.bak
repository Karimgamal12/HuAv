...
from V_P_N_8 import StartTime, jepiq, JEPVERSION
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ 𝙰𝙻𝙼𝙾𝙽𝚉𝙴𝚁  𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ ](t.me/V_P_N_8)父**"
...
**‌‎{EMOJI}‌‎𝙰𝙻𝙼𝙾𝙽𝚉𝙴𝚁  𖠄 {telever}** ٫
**‌‎{EMOJI}‌‎𝚄𝙿𝚃𝙸𝙼𝙴 𖠄 {uptime}** ٫
‌‎**{EMOJI}‌‎‌‎𝙿𝙸𝙽𝙶 𖠄 {ping}** ٫
**𖠄 𝙰𝙻𝙼𝙾𝙽𝚉𝙴𝚁  𝘂𝘀𝗲𝗿𝗯𝗼𝘁 𖠄**"""
